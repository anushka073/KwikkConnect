      ...
      <div key={msg.id} className={`flex ${isOwnMessage ? 'justify-end' : 'justify-start'} mb-4`}>
        <div className={`flex max-w-[80%] ${isOwnMessage ? 'flex-row-reverse' : 'flex-row'} space-x-2`}>
          ...
          <div className={`flex flex-col ${isOwnMessage ? 'items-end' : 'items-start'}`}>
            ...
            } ${msg.type === 'suggestion' ? 'border-accent' : ''}`}>
              {msg.type === 'code' ? (
                <div>
        ...
        <div className="flex items-end space-x-2">
          ...
          <div className="flex-1">
            <textarea
              ...
              className="w-full px-3 py-2 text-sm bg-background border border-border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-ring max-h-32"
              rows="2"
            />
          </div>
